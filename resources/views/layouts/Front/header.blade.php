                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="top-left">
                        <ul class="menu-top-link">
                            ...
                            <li>
                                <div class="select-position">
                                    <form action="{{ route('lang.switch') }}" method="POST" id="lang-form">
                                        @csrf
                                        <div class="select-position">
                                            <select name="locale" onchange="document.getElementById('lang-form').submit()">
                                                ...
                                                <option value="es"  {{ session('locale','en') == 'es'  ? 'selected' : '' }}>Español</option>
                                                <option value="fil" {{ session('locale','en') == 'fil' ? 'selected' : '' }}>Filipino</option>
                                                <option value="fr"  {{ session('locale','en') == 'fr'  ? 'selected' : '' }}>Français</option>
                                                <option value="ar"  {{ session('locale','en') == 'ar'  ? 'selected' : '' }}>العربية</option>
                                                <option value="hi"  {{ session('locale','en') == 'hi'  ? 'selected' : '' }}>हिन्दी</option>
                                                <option value="bn"  {{ session('locale','en') == 'bn'  ? 'selected' : '' }}>বাংলা</option>
                                            </select>
                                        </div>
                                    </form>
                                </div>
                                                ...
                                                <li>
                                                    ...
                                                    {{-- @if($cart->product->images && $cart->product->images->count() > 0)
                                                        <div class="cart-img-head">
                                                            <a class="cart-img" href="{{ route('showproduct', $cart->product->slug) }}">
                                                                <img
                                                                    src="{{ asset('storage/' . $cart->product->images->first()->path) }}"
                                                    ...
                                                    @else
                                                        <div class="cart-img-head">
                                                            <a class="cart-img" href="{{ route('showproduct', $cart->product->slug) }}">
                                                                <img
                                                                    src="{{ asset('storage/Product/Noimage.webp') }}"
                                                                    alt="{{ $cart->product->name }}"
                                                                    style="width:70px; height:70px; object-fit:cover;">
                                                            </a>
                                                        </div>
                            ...
                            <ul id="nav" class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="dd-menu collapsed" href="javascript:void(0)" data-bs-toggle="collapse"
                                        data-bs-target="#submenu-1-2">Pages</a>
                                ...
                                <li class="nav-item">
                                    <a class="dd-menu collapsed" href="javascript:void(0)" data-bs-toggle="collapse"
                                        data-bs-target="#submenu-1-3">Shop</a>
